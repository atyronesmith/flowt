...
type DNSNB struct {
	ExternalIds OVSMapString `json:"external_ids"`
	Records     OVSMapString `json:"records"`
}
...
type LoadBalancerNB struct {
	...
	IpPortMappings  OVSMapString   `json:"ip_port_mappings"`
	Name            *string        `json:"name"`
	Options         OVSMapString   `json:"options"`
...
type LogicalRouterPortNB struct {
	...
	Ipv6RaConfigs  OVSMapString   `json:"ipv6_ra_configs"`
	Mac            *string        `json:"mac"`
	Name           *string        `json:"name"`
...
// QoS
type QoSNB struct {
	Action      OVSMapInt    `json:"action"`
	Bandwidth   OVSMapInt    `json:"bandwidth"`
	Direction   *string      `json:"direction"`
	ExternalIds OVSMapString `json:"external_ids"`
	Match       *string      `json:"match"`
	Priority    *int         `json:"priority"`
